...
<head>
    ...
    <title>Registro - Ultra CRM</title>
...
<body class="flex items-center justify-center min-h-screen p-4">
    <div class="auth-card w-full max-w-md rounded-[2.5rem] p-10 md:p-14">
        ...
        <h1 class="text-3xl font-black text-slate-900 mb-2 text-center">Crea tu cuenta</h1>
        <p class="text-slate-400 text-center mb-10 text-sm font-medium">Empieza a gestionar tus prospectos hoy</p>

        <form id="registerForm" class="space-y-5">
            <div class="space-y-2">
                <label class="text-[10px] font-black uppercase tracking-widest text-slate-500 ml-1">Nombre Completo</label>
                <div class="relative">
                    <i data-lucide="user" class="absolute left-5 top-1/2 -translate-y-1/2 text-slate-300 w-5 h-5"></i>
                    <input type="text" name="name" required placeholder="Juan Pérez" class="w-full bg-slate-50 border border-slate-200 rounded-2xl py-4 pl-14 pr-6 outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all text-slate-900">
                </div>
            </div>
            <div class="space-y-2">
            ...
            <button type="submit" class="w-full bg-indigo-600 hover:bg-indigo-700 text-white py-4 rounded-2xl font-bold shadow-xl shadow-indigo-100 transition-all active:scale-[0.98] mt-6">Crear Cuenta</button>
        </form>

        <p class="text-center mt-10 text-slate-500 text-sm">
            ?Ya tienes cuenta? <a href="login.php" class="font-bold text-indigo-600 hover:text-indigo-700">Inicia Sesión</a>
        </p>
    </div>
