    ...
    try {
        ...
        if ($user_role === 'admin') {
            ...
            foreach ($landings as &$l) {
                $l['url']         = $BASE_URL . rawurlencode($l['filename']);
                $l['url_display'] = str_replace(['http://', 'https://'], '', CRM_URL) . '/landings_gen/' . $l['filename'];
                $l['can_delete']  = true;
                $l['is_admin']    = true;
                ...
                if (empty($subs)) {
                    $adminUrl = CRM_URL . '/landings_gen/' . urlencode($adminSlug) . '?lp=' . $l['id'];
                    $subs[] = [
                        'name'        => $adminName . ' (tú)',
                        'slug'        => $adminSlug,
                        'url'         => $adminUrl,
                        'url_display' => str_replace(['http://', 'https://'], '', $adminUrl),
                    ];
                }
